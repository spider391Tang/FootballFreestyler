...
if (worksSection && !document.querySelector("#signature-moves")) {
  worksSection.insertAdjacentHTML("beforebegin", `
    <section id="signature-moves" class="section signature-moves" aria-labelledby="signature-title" data-signature-moves>
      <div class="section-number" aria-hidden="true">技</div>
      <div class="signature-shell">
        <div class="signature-heading" data-reveal>
          <p class="eyebrow"><span></span> Signature Moves · 球花寶典</p>
          <h2 id="signature-title">把擅長的招式，<br />練成自己的<span>江湖名號。</span></h2>
          <p>這裡收藏我的代表技巧與舞台招式。從雙球控制、Lower、Upper、Sit-down 到各種 Transition，之後會持續把新的得意技加入這本「球花寶典」。</p>
        </div>
        <article class="signature-card" data-reveal>
          <div class="signature-video"><iframe src="https://www.youtube-nocookie.com/embed/CFNJCOmJ7Kw" title="唐心磊二刀流，同時控制兩顆足球的花式足球招式" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
          <div class="signature-copy"><p class="signature-index">第一式 · TWO-BALL CONTROL</p><h3>二刀流</h3><p class="signature-subtitle">同時踢兩顆球</p><p>左右腳各自掌握一顆球，在不同節奏中維持高度、落點與連續觸球。看起來像兩條軌道同時運行，真正的難度是讓雙腳各自獨立，卻又保持整體節奏一致。</p><dl><div><dt>招式類型</dt><dd>雙球控制</dd></div><div><dt>核心能力</dt><dd>節奏分離・左右腳協調</dd></div><div><dt>舞台特色</dt><dd>高辨識度・視覺張力</dd></div></dl><a href="https://youtube.com/shorts/CFNJCOmJ7Kw" target="_blank" rel="noreferrer">觀看完整招式 <i aria-hidden="true">↗</i></a></div>
        </article>
        <p class="signature-coming" data-reveal><span>COMING NEXT</span> 更多代表招式將陸續收錄</p>
      </div>
    </section>
  `);
