  ...
  serviceList.insertAdjacentHTML("afterend", `
    <article class="lesson-plan" data-lesson-plan data-reveal aria-labelledby="lesson-plan-title">
      <div class="lesson-plan-intro">
        ...
        <dl class="lesson-plan-facts"><div><dt>適合對象</dt><dd>兒童・青少年・成人</dd></div><div><dt>建議時間</dt><dd>60–90 分鐘</dd></div><div><dt>課程程度</dt><dd>零基礎可參加</dd></div><div><dt>課程場地</dt><dd>室內／戶外皆可</dd></div></dl>
        <div class="lesson-plan-actions"><a class="button button-primary" href="https://www.facebook.com/share/r/1BWEJ2tgqP/?mibextid=wwXIfr" target="_blank" rel="noreferrer"><span>觀看教學示範</span><span aria-hidden="true">↗</span></a><a class="lesson-plan-contact" href="#contact">洽詢課程合作 <i aria-hidden="true">↗</i></a></div>
      </div>
      <div class="lesson-plan-content"><p class="lesson-plan-kicker">COURSE FLOW</p><ol class="lesson-flow"><li><span>01</span><div><strong>動態暖身與球感</strong><p>用移動、反應遊戲與腳底帶球喚醒身體，熟悉足球的重量與彈性。</p></div></li><li><span>02</span><div><strong>基礎控球</strong><p>從腳背甜蜜點、左右腳交換與低高度連續觸球，建立穩定節奏。</p></div></li><li><span>03</span><div><strong>第一個花式動作</strong><p>依程度練習 Foot Stall、Around the World 入門拆解，或基礎 Transition。</p></div></li><li><span>04</span><div><strong>闖關與分組挑戰</strong><p>把技術變成遊戲，透過個人任務、接力與團隊合作累積成功經驗。</p></div></li><li><span>05</span><div><strong>小組合與成果分享</strong><p>選擇喜歡的動作串成短組合，用自己的節奏完成最後展示。</p></div></li></ol><div class="lesson-outcomes"><p>課程帶走的不只是一個招式</p><ul><li>身體協調與左右腳控制</li><li>專注力、耐心與挫折調整</li><li>舞台自信與創意表達</li><li>團隊互動與互相鼓勵</li></ul></div></div>
    </article>
  `);
...
if (familyVideoGrid && !familyVideoGrid.querySelector("[data-family-video-ils9]")) {
  familyVideoGrid.insertAdjacentHTML("beforeend", `
    <article class="short-video-card featured" data-family-video-ils9>
      <div class="short-video-frame"><iframe src="https://www.youtube-nocookie.com/embed/IlS9u0WfnFk" title="唐心磊與夏姬親子花式足球演出影片" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
      <div class="short-video-copy"><p><span>04</span> FAMILY PERFORMANCE</p><h4>親子花式足球演出</h4><p>父女把技巧、節奏與默契帶上舞台，讓足球不只在空中舞動，也成為一家人共同完成的表演故事。</p><a href="https://youtube.com/shorts/IlS9u0WfnFk" target="_blank" rel="noreferrer">前往 YouTube 觀看 <i aria-hidden="true">↗</i></a></div>
    </article>
  `);
}
