...
- `services-event.css` 管理演出合作頁中花蓮萬家福案例的照片圖庫、原生影片與響應式版型。
...
├── index.html                 # SEO metadata、Hero、最新演出公告、內容目錄與聯絡入口
├── about.html                 # 個人故事與 2014 巴西世界盃內容
├── family.html                # 親子演出、2026 最佳新人獎照片與影片
├── signature.html             # 得意技與招式影片
├── services.html              # 合作形式、教案與花蓮萬家福合作案例
├── services-event.css         # 花蓮萬家福活動照片、影片與 RWD
...
└── assets/
    ...
    │   └── 20260725_威斯汀酒店/
    │       ├── ReadMe.md      # 2026-07-25 世界盃賽後花式足球秀公告
    │       └── worldcup_westin_performance.jpg
    ├── media/
    │   └── 20260718-hualien-wanjiafu/
    │       ├── *.jpg          # 活動原始照片與影片 poster
    │       ├── *-960.webp     # 960px 響應式照片衍生檔
    │       ├── *-1440.webp    # 1440px 響應式照片衍生檔
    │       └── *.mp4          # 雙人演出與互動教學精選直式影片
    └── photos/
...
1. `index.html`：Hero、最新演出公告、Quick Route 六張導覽卡與社群聯絡入口。
...
5. `services.html`：舞台演出、親子演出、校園推廣、品牌合作、教案，以及 2026 花蓮萬家福世界盃主題演出的照片圖庫與兩支精選影片。
...
- `index.html` 首頁目前顯示 2026-07-25 大溪威斯汀世界盃賽後花式足球秀公告；活動結束後應更新狀態或下架。
...
- `signature.html` 目前收錄二刀流與繩球合一；`services.html` 收錄合作形式、教案，以及 2026 花蓮萬家福世界盃主題演出的四張照片與兩支自有託管影片。
- `experience.html` 以 timeline 呈現 2018–2026 的重要經歷。
- `assets/announcements/20260725_威斯汀酒店/` 保存 2026-07-25 大溪威斯汀世界盃賽後花式足球秀公告與宣傳圖。
