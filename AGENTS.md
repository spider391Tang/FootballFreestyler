...
- `experience.css` 管理花蓮萬家福活動專題的照片圖庫、原生影片與響應式版型。
...
├── experience.html            # 重要經歷 timeline 與花蓮萬家福活動專題
├── experience.css             # 花蓮萬家福活動照片、影片與 RWD
...
6. `experience.html`：國際賽事、獎項與跨界演出的 timeline，以及 2026 花蓮萬家福世界盃主題演出的照片圖庫與兩支精選影片。
...
- `experience.html` 以 timeline 呈現 2018–2026 的重要經歷，並收錄 2026 花蓮萬家福世界盃主題演出的四張照片與兩支自有託管影片。
