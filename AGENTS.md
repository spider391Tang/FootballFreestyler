...
3. `#about`：Spider 個人介紹、統計資訊、人物故事時間軸、百傳媒專訪與封面人物影片。
...
7. `#works`：Selected Moments 演出照片集，並包含世足之夜、桃園市街客家體表會、夏日松一下與大溪威斯汀世界盃演出履歷。
8. `#honors`：重要獎項與經歷；第五、七屆巨城街頭藝術節及 2019 Okinawa Freestyle Football Open 項目附外部紀錄連結，並包含民視《幸福保衛站》電視演出卡片。
